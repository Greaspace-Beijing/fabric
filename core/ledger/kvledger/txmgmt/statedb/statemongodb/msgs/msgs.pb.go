...
package msgs // import "github.com/hyperledger/fabric/core/ledger/kvledger/txmgmt/statedb/statemongodb/msgs"
...
func (*MongoVersionFieldProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_msgs_vxf998imicx8up5q, []int{0}
}
...
func init() { proto.RegisterFile("msgs.proto", fileDescriptor_msgs_vxf998imicx8up5q) }

var fileDescriptor_msgs_vxf998imicx8up5q = []byte{
