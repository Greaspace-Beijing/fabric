...
func testMain(m *testing.M) int {
	...
	viper.Set("peer.fileSystemPath", "C:\\Users\\Administrator\\Documents\\statedb\\statemongodb")
	//viper.Set("peer.fileSystemPath", "/tmp/fabric/ledgertests/kvledger/txmgmt/statedb/statemongodb")

	// Switch to MongoDB
	mongoAddress, cleanup := mongoDBSetup()
	defer cleanup()

	//mongoAddress, _ := mongoDBSetup()
	...
	flogging.ActivateSpec("statemongodb,mongodb=debug")
	//run the actual test
	return m.Run()
}
